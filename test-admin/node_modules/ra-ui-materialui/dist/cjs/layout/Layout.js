...
var Layout = function (props) {
    var _a = props.appBar, AppBar = _a === void 0 ? AppBar_1.AppBar : _a, appBarAlwaysOn = props.appBarAlwaysOn, children = props.children, className = props.className, dashboard = props.dashboard, errorComponent = props.error, _b = props.menu, Menu = _b === void 0 ? Menu_1.Menu : _b, _c = props.sidebar, Sidebar = _c === void 0 ? Sidebar_1.Sidebar : _c, title = props.title, rest = __rest(props, ["appBar", "appBarAlwaysOn", "children", "className", "dashboard", "error", "menu", "sidebar", "title"]);
    ...
    return (react_1.default.createElement(StyledLayout, __assign({ className: (0, clsx_1.default)('layout', className) }, rest),
        ...
        react_1.default.createElement("div", { className: exports.LayoutClasses.appFrame },
            react_1.default.createElement(AppBar, { open: open, title: title, alwaysOn: appBarAlwaysOn }),
