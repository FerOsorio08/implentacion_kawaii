...
var CreateButton = function (props) {
    ...
    return isSmall ? (React.createElement(StyledFab, __assign({ component: react_router_dom_1.Link, to: createPath({ resource: resource, type: 'create' }), state: scrollStates[String(scrollToTop)], 
