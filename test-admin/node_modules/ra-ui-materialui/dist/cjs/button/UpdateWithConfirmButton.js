...
var UpdateWithConfirmButton = function (props) {
    ...
    var mutationMeta = mutationOptions.meta, _h = mutationOptions.onSuccess, onSuccess = _h === void 0 ? function () {
        ...
        setOpen(false);
    } : _j, otherMutationOptions = __rest(mutationOptions, ["meta", "onSuccess", "onError"]);
    var _k = (0, ra_core_1.useUpdate)(), updateMany = _k[0], isLoading = _k[1].isLoading;
    ...
    var handleUpdate = function (e) {
        updateMany(resource, { id: record.id, data: data, meta: mutationMeta, previousData: record }, __assign({ onSuccess: onSuccess, onError: onError, mutationMode: mutationMode }, otherMutationOptions));
        ...
        React.createElement(layout_1.Confirm, { isOpen: isOpen, loading: isLoading, title: confirmTitle, content: confirmContent, translateOptions: {
                ...
                name: translate("resources.".concat(resource, ".forcedCaseName"), {
                    ...
                    _: inflection_1.default.humanize(translate("resources.".concat(resource, ".name"), {
                        smart_count: 1,
                        _: inflection_1.default.inflect(resource, 1),
                    }), true),
                }),
...
var sanitizeRestProps = function (_a) {
    var filterValues = _a.filterValues, label = _a.label, rest = __rest(_a, ["filterValues", "label"]);
    return rest;
};
exports.UpdateWithConfirmButton.propTypes = {
