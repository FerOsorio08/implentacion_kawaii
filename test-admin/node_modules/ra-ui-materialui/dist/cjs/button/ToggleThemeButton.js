...
var ToggleThemeButton = function (props) {
    ...
    var _a = (0, layout_1.useThemesContext)(props), darkTheme = _a.darkTheme, defaultTheme = _a.defaultTheme;
    var prefersDarkMode = (0, material_1.useMediaQuery)('(prefers-color-scheme: dark)', {
        noSsr: true,
    });
    var _b = (0, layout_1.useTheme)(defaultTheme || (prefersDarkMode && darkTheme ? 'dark' : 'light')), theme = _b[0], setTheme = _b[1];
    // FIXME: remove in v5
    if (props.darkTheme) {
