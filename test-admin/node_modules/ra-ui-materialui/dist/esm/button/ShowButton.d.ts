...
export type ShowButtonProps<RecordType extends RaRecord = any> = Props<RecordType> & ButtonProps;
declare const PureShowButton: React.MemoExoticComponent<{
    <RecordType extends RaRecord<import("ra-core").Identifier> = any>(props: ShowButtonProps<RecordType>): JSX.Element;
    propTypes: {
