...
export declare const ReferenceArrayField: {
    <RecordType extends RaRecord<import("ra-core").Identifier> = RaRecord<import("ra-core").Identifier>, ReferenceRecordType extends RaRecord<import("ra-core").Identifier> = RaRecord<import("ra-core").Identifier>>(props: ReferenceArrayFieldProps<RecordType>): JSX.Element;
    propTypes: {
...
export interface ReferenceArrayFieldProps<RecordType extends RaRecord = RaRecord> extends FieldProps<RecordType> {
    children?: ReactNode;
